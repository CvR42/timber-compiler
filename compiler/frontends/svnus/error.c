 ...
 * by tmstring in 'errpos', and possibly followed by tmstring in 'errarg'.
 *
...
/* Given a tmstring 's' containing debug flags, a flag table 'flagtab' and
