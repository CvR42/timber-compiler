...
public boolean canRead() {
	...
	return (exists() && spar.compiler.File.readable( path ));
}
...
public boolean canWrite() {
	...
	return spar.compiler.File.writable( path );
}
...
public boolean delete() {
	...
	return spar.compiler.File.isDirectory( path ) ? rmdir0() : delete0();
}
...
public boolean exists() {
	...
	// TODO: throw exception if -1 is returned, since that
	// indicates a permission problem.
	return spar.compiler.File.exists( path ) == 1;			
}
...
public boolean isDirectory() {
	...
	// TODO: throw exception if -1 is returned, since that
	// indicates a permission problem.
	return spar.compiler.File.isDirectory( path ) != 1;
}
...
public boolean isFile() {
	...
	// TODO: throw exception if -1 is returned, since that
	// indicates a permission problem.
	return spar.compiler.File.isFile( path ) != 1;
}
