...
dbflag flagtab[] = {
    ...
    { 'a', &enableSidneyAggregation, "enable Sidney's Aggregation" },
    { 'c', &disableCommunicationAggregation, "disable Communication Aggregation" },
    { 'r', &disableReduction, "disable Reduction" },
    { 'o', &disableOwnerAbsorbtion, "disable Owner Absorbtion" },
    { 'l', &disableConditionLifting, "disable Condition Lifting" },
    { 'L', &enableLeoBypass, "enable Leo's Bypass" },
    { 'j', &enableArjanBypass, "enable Arjan's Bypass" },
    { 'O', &enableOwnerComputes, "enable alternative Owner Computes scheme" },
    { 'S', &enableSymbolicNumberOfProcessors, "use symbolic numberOfProcessors instead of constant" },
    { '\0', (bool *)0, "" },
};
